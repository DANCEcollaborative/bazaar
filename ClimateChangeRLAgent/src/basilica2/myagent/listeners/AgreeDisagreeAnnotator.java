...
public class AgreeDisagreeAnnotator extends BasilicaAdapter
{
    ...
    String[] agreeDisagreeAnnotatorTrueThreshold;
	...
	public AgreeDisagreeAnnotator(Agent a)
	{
		...
		agreeDisagreeAnnotatorTrueThreshold = RLproperties.getProperty("agreedisagree_annotator_true_threshold", "70,60,50,40,30").split(",");
		...
		if(chosenEngagementLevel<agreeDisagreeAnnotatorTrueThreshold.length) {
			classificationList[1]=agreeDisagreeAnnotatorTrueThreshold[chosenEngagementLevel];
		}
	...
	public String parseLightSideResponse(StringBuilder response)
	{
		...
		for (int i=0; i < listLength; i++) {
			...
			try {
				...
				System.err.println("AgreeDisagreeAnnotator, classification="+classification+" classificationThreshold="+classificationThreshold);
