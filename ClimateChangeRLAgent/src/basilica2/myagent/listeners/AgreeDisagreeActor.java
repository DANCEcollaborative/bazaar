...
{	
	...
	public boolean shouldTriggerOnCandidate(MessageEvent me)
	{
		...
		log(Logger.LOG_NORMAL, me.getFrom()+"'s " +candidateLabel+ " ratio="+ratio+" targetRatio="+targetRatio);
		...
		System.err.println("AgreeDisagreeActor, shouldTriggerOnCandidate = "+(ratio < targetRatio));
