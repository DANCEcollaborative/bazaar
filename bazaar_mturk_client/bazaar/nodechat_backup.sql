...
CREATE TABLE `room` (
  ...
  `modified` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'The last time this room was entered by a chat user.',
  `comment` varchar(10000) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name_UNIQUE` (`name`)
) AUTO_INCREMENT=316 DEFAULT CHARSET=utf8;

CREATE TABLE `room_prefix` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL COMMENT 'The prefix name of the chat room',
