...
public class FileActor extends BasilicaAdapter
{
	...
	private void respondTestA(InputCoordinator source, FileEvent event) {
		...
		String prompt = "You've passed a test case for the number of lines your program will output. Do you need to know the number of output lines for an iterative solution?"; 
	...
	private void respondTestB(InputCoordinator source, FileEvent event) {
		...
		String prompt = "Now that you're ready to begin working on passing the next test case, it's time to switch the Driver and Navigator roles. Why don't you be the Driver, Joe, and you be the Navigator, Eric?"; 
