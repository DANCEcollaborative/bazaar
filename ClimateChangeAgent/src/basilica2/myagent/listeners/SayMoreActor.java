...
public class SayMoreActor extends AbstractAccountableActor
{
	...
	{
		System.err.println("ClimateChange SayMoreActor, enter shouldTriggerOnCandidate"); 
	...
	{
		System.err.println("ClimateChange SayMoreActor, enter shouldAnnotateAsCandidate"); 
