 ...
 * @author dadamson
 */
public class JeopardyTutorTurnWatcher extends BasilicaAdapter implements TimeoutReceiver
{
	...
	private int turn_response_timeout = 30;
	...
	public JeopardyTutorTurnWatcher(Agent a)
	{
		super(a);
