...
//		Logger.commonLog(getClass().getSimpleName(),Logger.LOG_NORMAL,"Executing logstate step ...");
		...
		System.err.println("LogStateStepHandler, execute - LogStateEvent created: stateTag: " + stateTag
				+ "  stateValue: " + stateValue + "  stateValue: " + stateValue + "  sendLog: " + sendLogString
				+ "  logTag: " + logTag);
		Logger.commonLog(getClass().getSimpleName(), Logger.LOG_NORMAL,
				"LogStateStepHandler, execute - LogStateEvent created: stateTag: " + stateTag + "  stateValue: "
						+ stateValue + "  stateValue: " + stateValue + "  sendLog: " + sendLogString + "  logTag: "
						+ logTag);
