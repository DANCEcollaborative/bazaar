...
public class LlmTopicListener2 extends BasilicaAdapter
{
	public String host;
	public String port; 
	public String path;
	...
	public LlmTopicListener2(Agent a)
	{
		super(a);
...
//				System.err.println("URLLLLL: "+requestURL);
	...
	public void preProcessEvent(InputCoordinator source, Event e)
	{
		...
		{
	        System.err.println("LlmTopicListener preProcessEvent for MessageEvent");
			finish = Instant.now();
			long timeElapsed = Duration.between(start, finish).toMillis();
			if (timeElapsed > 1500) {
				boolean proceed = messageFilter((MessageEvent) e);
				if (proceed) {
			        System.err.println("LlmTopicListener preProcessEvent: calling handleMessageEvent");
					try {
...
//                .collect(Collectors.toList());
	...
	public void handleMessageEvent(InputCoordinator source, MessageEvent me) throws JSONException {
        ...
        System.err.println("LlmTopicListener handleMessageEvent -- jsonPayload: " + jsonPayload);
	    
	    // Sending the message to OpenAI and receiving the response
	    String response = sendToOpenAI(source, jsonPayload, false);
        System.err.println("LlmTopicListener handleMessageEvent -- OpenAI response: " + response);
	    if (! response.isEmpty()) {
