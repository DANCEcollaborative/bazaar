...
//				System.err.println("LlmPromptListener contextLen " + String.valueOf(contextLen));
			}
...
//		System.err.println("LlmPromptListener, getAllMessages - ENTER"); 
		
		String allMessages = "Conversation in the chatroom:\n\n";
	    try {
 			BasilicaListener CHL = source.getListenerByName("PromptHistoryListener");
 			
// 			System.err.println("LlmPromptListener, getAllMessages = CHL: " + CHL.toString()); 
 			
		    JSONArray chatHistory = ((PromptHistoryListener) CHL).retrieveChatHistory(this.contextLen);
		    
//		    System.err.println("\n\nLlmPromptListener: chatHistory vv ");
            for (int i = 0; i < chatHistory.length(); i++) {
                Object value = chatHistory.get(i);
//                System.err.println("Element " + i + ": " + value);
            }		    
//		    System.err.println("LlmPromptListener: chatHistory ^^\n\n");
...
//	 			System.err.println("LlmPromptListener, getAllMessages - currentMessage: " + currentMessage); 
...
//		System.err.println("LlmPromptListener, getAllMessages - allMessages: " + allMessages); 
...
//		    System.err.println("LlmPromptListener: calling getAllMessages()");
		    String allMessages = getAllMessages(source, prompt, promptSender);
//		    System.err.println("LlmPromptListener - allMessages: " + allMessages);
