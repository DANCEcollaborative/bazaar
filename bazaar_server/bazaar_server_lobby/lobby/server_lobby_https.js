...
app.use(function(req, res, next) {
    res.setHeader("Content-Security-Policy", "default-src https://docs.google.com/ https://erebor.lti.cs.cmu.edu:* https://bazaar.lti.cs.cmu.edu:* https://forum.lti.cs.cmu.edu:* https://collab.lti.cs.cmu.edu:* https://cdn.jsdelivr.net/gh/DANCECollaborative/ https://exodar.oli.cmu.edu/baz/static/; connect-src 'self' ws://bazaar.lti.cs.cmu.edu/bazsocket/ http://bazaar.lti.cs.cmu.edu/bazsocket/ wss://bazaar.lti.cs.cmu.edu/bazsocket/ https://bazaar.lti.cs.cmu.edu/bazsocket/ ws://bazaar.lti.cs.cmu.edu/bazsocket/ http://bazaar.lti.cs.cmu.edu/local/bazsocket/ wss://bazaar.lti.cs.cmu.edu/local/bazsocket/ https://bazaar.lti.cs.cmu.edu/ https://cdn.jsdelivr.net/gh/DANCECollaborative/; style-src 'self' https://cdn.jsdelivr.net https://fonts.googleapis.com/css https://cdn.jsdelivr.net/gh/DANCECollaborative/ https://cdn.jsdelivr.net/gh/DANCECollaborative/bazaar/bazaar_server/bazaar_server_lobby/lobby/html_pages/JSMQ.js https://cdn.jsdelivr.net/gh/DANCECollaborative/bazaar/bazaar_server/bazaar_server_lobby/lobby/html_pages/text_audio.js https://rawgit.com/gtomar/ 'unsafe-inline'; script-src 'self' https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js https://rawgit.com/gtomar/ https://rawgit.com/marinawang/ https://cdnjs.cloudflare.com/ajax/libs/socket.io/ 'unsafe-inline'; font-src 'self' https://fonts.gstatic.com/; img-src * data; frame-src https://sketchfab.com/"); 
    return next();
});
