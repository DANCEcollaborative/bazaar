...
app.use(function(req, res, next) {
    res.setHeader("Content-Security-Policy", "default-src 'self' *.docs.google.com/spreadsheets *.erebor.lti.cs.cmu.edu *.collab.lti.cs.cmu.edu https://cdn.jsdelivr.net/gh/DANCECollaborative/bazaar@latest/bazaar_server/bazaar_server_OLI/server/bazaar/static/vertical.pdf https://cdn.jsdelivr.net/gh/DANCECollaborative/bazaar@latest/bazaar_server/bazaar_server_OLI/server/bazaar/static/horizontal.pdf; connect-src 'self' ws://collab.lti.cs.cmu.edu/bazsocket/ http://collab.lti.cs.cmu.edu/bazsocket/ wss://collab.lti.cs.cmu.edu/bazsocket/ https://collab.lti.cs.cmu.edu/bazsocket/ ws://collab.lti.cs.cmu.edu/bazsocket/ http://collab.lti.cs.cmu.edu/local/bazsocket/ wss://collab.lti.cs.cmu.edu/local/bazsocket/ https://collab.lti.cs.cmu.edu/local/bazsocket/; style-src 'self' https://fonts.googleapis.com/css https://cdn.jsdelivr.net/gh/DANCECollaborative/bazaar@latest/bazaar_server/bazaar_server_https/bazaar/discussionnew2.css https://rawgit.com/gtomar/help-button-javascript/master/discussion.css 'unsafe-inline'; script-src 'self' https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js https://rawgit.com/gtomar/stylesheets/master/colors.js https://rawgit.com/gtomar/stylesheets/master/jquery.sortable.js https://rawgit.com/marinawang/bazaar/master/client.js https://cdnjs.cloudflare.com/ajax/libs/socket.io/2.3.0/socket.io.js 'unsafe-inline'; font-src 'self' https://fonts.gstatic.com/s/oxygen/v10/2sDfZG1Wl4LcnbuKjk0mRUe0Aw.woff2 https://fonts.gstatic.com/s/oxygen/v10/2sDfZG1Wl4LcnbuKgE0mRUe0A4Uc.woff2; img-src *"); 
    return next();
});
