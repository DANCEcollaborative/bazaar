...
app.use(function(req, res, next) {
    res.setHeader("Content-Security-Policy", "default-src https://docs.google.com/ https://erebor.lti.cs.cmu.edu:* https://bazaar.lti.cs.cmu.edu:* https://forum.lti.cs.cmu.edu:* https://collab.lti.cs.cmu.edu:* https://cdn.jsdelivr.net/gh/DANCECollaborative/ https://exodar.oli.cmu.edu/baz/static/ https://vlab-chatbot.vercel.app/ https://melodic-souffle-afa758.netlify.app/ https://transcendent-sunburst-b5c638.netlify.app/ https://precious-sunburst-f465c5.netlify.app/ https://graceful-torrone-c9b66d.netlify.app/ https://harmonious-taiyaki-fe3d07.netlify.app/ https://munano.org/virtual-lab-hints-template/ https://frabjous-bonbon-c3ec30.netlify.app/ https://cryptpad.fr/doc https://chemcollective.org/ https://virtual-lab-part1.pages.dev/ https://virtual-lab-part2-1.pages.dev/ https://virtual-lab-part2-2.pages.dev/ https://virtual-lab-part3.pages.dev/ https://virtual-lab-part3-2.pages.dev/ https://virtual-lab-part4.pages.dev/; connect-src 'self' ws://bazaar.lti.cs.cmu.edu/bazsocket/ http://bazaar.lti.cs.cmu.edu/bazsocket/ wss://bazaar.lti.cs.cmu.edu/bazsocket/ https://bazaar.lti.cs.cmu.edu/bazsocket/ ws://bazaar.lti.cs.cmu.edu/bazsocket/ http://bazaar.lti.cs.cmu.edu/local/bazsocket/ wss://bazaar.lti.cs.cmu.edu/local/bazsocket/ https://bazaar.lti.cs.cmu.edu/ https://cdn.jsdelivr.net/gh/DANCECollaborative/; style-src 'self' https://cdn.jsdelivr.net https://fonts.googleapis.com/css https://cdn.jsdelivr.net/gh/DANCECollaborative/ https://rawgit.com/gtomar/ 'unsafe-inline'; script-src 'self' https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js https://rawgit.com/gtomar/ https://rawgit.com/marinawang/ https://cdnjs.cloudflare.com/ajax/libs/socket.io/ https://cdn.jsdelivr.net 'unsafe-inline'; font-src 'self' https://fonts.gstatic.com/; img-src * data; frame-src https://sketchfab.com/ https://colab.research.google.com/ https://docs.google.com/ https://vlab-chatbot.vercel.app/ https://melodic-souffle-afa758.netlify.app/ https://transcendent-sunburst-b5c638.netlify.app/ https://precious-sunburst-f465c5.netlify.app/ https://graceful-torrone-c9b66d.netlify.app/ https://harmonious-taiyaki-fe3d07.netlify.app/ https://munano.org/virtual-lab-hints-template/ https://frabjous-bonbon-c3ec30.netlify.app/ https://cryptpad.fr/doc https://chemcollective.org/ https://virtual-lab-part1.pages.dev/ https://virtual-lab-part2-1.pages.dev/ https://virtual-lab-part2-2.pages.dev/ https://virtual-lab-part3.pages.dev/ https://virtual-lab-part3-2.pages.dev/ https://virtual-lab-part4.pages.dev/");
    return next();
});
