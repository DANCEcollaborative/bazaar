...
app.use(function(req, res, next) {
    res.setHeader("Content-Security-Policy", "default-src https://docs.google.com https://erebor.lti.cs.cmu.edu:* https://bazaar.lti.cs.cmu.edu:* https://forum.lti.cs.cmu.edu:* https://collab.lti.cs.cmu.edu:* https://cdn.jsdelivr.net/gh/DANCECollaborative/bazaar@latest/bazaar_server/bazaar_server_OLI/server/bazaar/static/vertical.pdf https://cdn.jsdelivr.net/gh/DANCECollaborative/bazaar@latest/bazaar_server/bazaar_server_OLI/server/bazaar/static/horizontal.pdf https://cdn.jsdelivr.net/gh/DANCECollaborative/bazaar@latest/bazaar_server/bazaar_server_OLI/server/bazaar/static/mayoralLetter.pdf; connect-src 'self' ws://bazaar.lti.cs.cmu.edu/bazsocket/ http://bazaar.lti.cs.cmu.edu/bazsocket/ wss://bazaar.lti.cs.cmu.edu/bazsocket/ https://bazaar.lti.cs.cmu.edu/bazsocket/ ws://bazaar.lti.cs.cmu.edu/bazsocket/ http://bazaar.lti.cs.cmu.edu/local/bazsocket/ wss://bazaar.lti.cs.cmu.edu/local/bazsocket/ https://bazaar.lti.cs.cmu.edu/local/bazsocket/ ws://collab.lti.cs.cmu.edu/bazsocket/ http://collab.lti.cs.cmu.edu/bazsocket/ wss://collab.lti.cs.cmu.edu/bazsocket/ https://collab.lti.cs.cmu.edu/bazsocket/ ws://collab.lti.cs.cmu.edu/bazsocket/ http://collab.lti.cs.cmu.edu/local/bazsocket/ wss://collab.lti.cs.cmu.edu/local/bazsocket/ https://collab.lti.cs.cmu.edu/local/bazsocket/; style-src 'self' https://fonts.googleapis.com/css https://cdn.jsdelivr.net/gh/DANCECollaborative/bazaar@latest/bazaar_server/bazaar_server_https/bazaar/discussionnew2.css https://rawgit.com/gtomar/help-button-javascript/master/discussion.css 'unsafe-inline'; script-src 'self' https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js https://rawgit.com/gtomar/stylesheets/master/colors.js https://rawgit.com/gtomar/stylesheets/master/jquery.sortable.js https://rawgit.com/marinawang/bazaar/master/client.js https://cdnjs.cloudflare.com/ajax/libs/socket.io/2.3.0/socket.io.js 'unsafe-inline'; font-src 'self' https://fonts.gstatic.com/s/oxygen/v10/2sDfZG1Wl4LcnbuKjk0mRUe0Aw.woff2 https://fonts.gstatic.com/s/oxygen/v10/2sDfZG1Wl4LcnbuKgE0mRUe0A4Uc.woff2; img-src * data"); 
    return next();
});
...
const chat_url = "https://collab.lti.cs.cmu.edu/bazaar/chat/";
const roomname_prefix = "climatechange";
...
{
  // winston.log('info',"server_lobby.js, createSession -- " + nick + " trying to join, consent="+consent + " reset="+reset);
  if (nick.length > 50) return null;
   
  //rejects invalid nicknames
  if (/[^\w_\-^! ]/.exec(nick)) 
  {
	winston.log('info',"server_lobby.js, createSession -- invalid nickname: " + nick);
	  return null;
  }
