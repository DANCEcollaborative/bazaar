...
--
-- Current Database: `SR_wiki`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `SR_wiki` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
--
-- Current Database: `edX`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `edX` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `djangobb_forum_attachment` (
  ...
  PRIMARY KEY (`id`),
  KEY `djangobb_forum_attachment_0800fc57` (`hash`),
  KEY `djangobb_forum_attachment_f3aa1999` (`post_id`),
  CONSTRAINT `djangobb_foru_post_id_3a17351ff3e1b698_fk_djangobb_forum_post_id` FOREIGN KEY (`post_id`) REFERENCES `djangobb_forum_post` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `djangobb_forum_ban` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ban_start` datetime(6) NOT NULL,
  `ban_end` datetime(6) DEFAULT NULL,
  `reason` longtext NOT NULL,
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`),
  CONSTRAINT `djangobb_forum_ban_user_id_ce9dedaf9946084_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `djangobb_forum_category_groups` (
  ...
  KEY `djangobb_forum_catego_group_id_224f1892ac3e5499_fk_auth_group_id` (`group_id`),
  CONSTRAINT `djang_category_id_364218f9a73a6ae7_fk_djangobb_forum_category_id` FOREIGN KEY (`category_id`) REFERENCES `djangobb_forum_category` (`id`),
  CONSTRAINT `djangobb_forum_catego_group_id_224f1892ac3e5499_fk_auth_group_id` FOREIGN KEY (`group_id`) REFERENCES `auth_group` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `djangobb_forum_forum` (
  ...
  `forum_logo` varchar(100) NOT NULL,
  `category_id` int(11) NOT NULL,
  `last_post_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `djang_category_id_2df6ae51d6fa51fb_fk_djangobb_forum_category_id` (`category_id`),
  KEY `djangobb_forum_forum_f9927d59` (`last_post_id`),
  CONSTRAINT `djang_category_id_2df6ae51d6fa51fb_fk_djangobb_forum_category_id` FOREIGN KEY (`category_id`) REFERENCES `djangobb_forum_category` (`id`),
  CONSTRAINT `djangobb_last_post_id_45e1a2aacb14aec3_fk_djangobb_forum_post_id` FOREIGN KEY (`last_post_id`) REFERENCES `djangobb_forum_post` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `djangobb_forum_forum_moderators` (
  ...
  KEY `djangobb_forum_forum_mo_user_id_384e94fb276ceda0_fk_auth_user_id` (`user_id`),
  CONSTRAINT `djangobb_fo_forum_id_7a0fb85327acefc5_fk_djangobb_forum_forum_id` FOREIGN KEY (`forum_id`) REFERENCES `djangobb_forum_forum` (`id`),
  CONSTRAINT `djangobb_forum_forum_mo_user_id_384e94fb276ceda0_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `djangobb_forum_poll` (
  ...
  `deactivate_date` datetime(6) DEFAULT NULL,
  `topic_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `djangobb_forum_poll_19b4d727` (`topic_id`),
  CONSTRAINT `djangobb_fo_topic_id_4a40f03c793510c4_fk_djangobb_forum_topic_id` FOREIGN KEY (`topic_id`) REFERENCES `djangobb_forum_topic` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `djangobb_forum_poll_users` (
  ...
  KEY `djangobb_forum_poll_use_user_id_3de8288addde9a92_fk_auth_user_id` (`user_id`),
  CONSTRAINT `djangobb_foru_poll_id_7fd369452818c64c_fk_djangobb_forum_poll_id` FOREIGN KEY (`poll_id`) REFERENCES `djangobb_forum_poll` (`id`),
  CONSTRAINT `djangobb_forum_poll_use_user_id_3de8288addde9a92_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `djangobb_forum_pollchoice` (
  ...
  `poll_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `djangobb_forum_poll_id_702157229411d30_fk_djangobb_forum_poll_id` (`poll_id`),
  CONSTRAINT `djangobb_forum_poll_id_702157229411d30_fk_djangobb_forum_poll_id` FOREIGN KEY (`poll_id`) REFERENCES `djangobb_forum_poll` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `djangobb_forum_post` (
  ...
  `user_ip` char(39) DEFAULT NULL,
  `topic_id` int(11) NOT NULL,
  `updated_by_id` int(11) DEFAULT NULL,
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `djangobb_forum_post_19b4d727` (`topic_id`),
  KEY `djangobb_forum_post_9ccf0ba6` (`updated_by_id`),
  KEY `djangobb_forum_post_e8701ad4` (`user_id`),
  CONSTRAINT `djangobb_fo_topic_id_6140e6c4bb8ab5af_fk_djangobb_forum_topic_id` FOREIGN KEY (`topic_id`) REFERENCES `djangobb_forum_topic` (`id`),
  CONSTRAINT `djangobb_forum_po_updated_by_id_6725245b78bc092c_fk_auth_user_id` FOREIGN KEY (`updated_by_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `djangobb_forum_post_user_id_3d941fcc88e24fc_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
...
CREATE TABLE `djangobb_forum_posttracking` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`),
  CONSTRAINT `djangobb_forum_posttrac_user_id_33306cf8c442f85f_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
...
CREATE TABLE `djangobb_forum_profile` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`),
  CONSTRAINT `djangobb_forum_profile_user_id_2ac8b0cca3af8e08_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `djangobb_forum_report` (
  ...
  PRIMARY KEY (`id`),
  KEY `djangobb_foru_post_id_4d907645de44ffeb_fk_djangobb_forum_post_id` (`post_id`),
  KEY `djangobb_forum_r_reported_by_id_28d313d47cdad2ed_fk_auth_user_id` (`reported_by_id`),
  KEY `djangobb_forum_rep_zapped_by_id_5164e532f1276542_fk_auth_user_id` (`zapped_by_id`),
  CONSTRAINT `djangobb_foru_post_id_4d907645de44ffeb_fk_djangobb_forum_post_id` FOREIGN KEY (`post_id`) REFERENCES `djangobb_forum_post` (`id`),
  CONSTRAINT `djangobb_forum_r_reported_by_id_28d313d47cdad2ed_fk_auth_user_id` FOREIGN KEY (`reported_by_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `djangobb_forum_rep_zapped_by_id_5164e532f1276542_fk_auth_user_id` FOREIGN KEY (`zapped_by_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `djangobb_forum_reputation` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `djangobb_forum_reputation_from_user_id_79a0a4cbfdbf0c6b_uniq` (`from_user_id`,`post_id`),
  KEY `djangobb_foru_post_id_6be63b96b50b02de_fk_djangobb_forum_post_id` (`post_id`),
  KEY `djangobb_forum_reputa_to_user_id_c401a424a2916d0_fk_auth_user_id` (`to_user_id`),
  CONSTRAINT `djangobb_foru_post_id_6be63b96b50b02de_fk_djangobb_forum_post_id` FOREIGN KEY (`post_id`) REFERENCES `djangobb_forum_post` (`id`),
  CONSTRAINT `djangobb_forum_repu_from_user_id_7fcb748dbae2bb3_fk_auth_user_id` FOREIGN KEY (`from_user_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `djangobb_forum_reputa_to_user_id_c401a424a2916d0_fk_auth_user_id` FOREIGN KEY (`to_user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `djangobb_forum_topic` (
  ...
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `djangobb_fo_forum_id_26a3555fe254869d_fk_djangobb_forum_forum_id` (`forum_id`),
  KEY `djangobb_last_post_id_418984dca1f920c7_fk_djangobb_forum_post_id` (`last_post_id`),
  KEY `djangobb_forum_topic_user_id_1fa0b77442148478_fk_auth_user_id` (`user_id`),
  CONSTRAINT `djangobb_fo_forum_id_26a3555fe254869d_fk_djangobb_forum_forum_id` FOREIGN KEY (`forum_id`) REFERENCES `djangobb_forum_forum` (`id`),
  CONSTRAINT `djangobb_forum_topic_user_id_1fa0b77442148478_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `djangobb_last_post_id_418984dca1f920c7_fk_djangobb_forum_post_id` FOREIGN KEY (`last_post_id`) REFERENCES `djangobb_forum_post` (`id`)
...
CREATE TABLE `djangobb_forum_topic_subscribers` (
  ...
  KEY `djangobb_forum_topic_su_user_id_26ba506ce550d3c8_fk_auth_user_id` (`user_id`),
  CONSTRAINT `djangobb_for_topic_id_5d1adbbf8859cdb_fk_djangobb_forum_topic_id` FOREIGN KEY (`topic_id`) REFERENCES `djangobb_forum_topic` (`id`),
  CONSTRAINT `djangobb_forum_topic_su_user_id_26ba506ce550d3c8_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Current Database: `lasad`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `lasad` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
--
-- Table structure for table `element_parent_mapping`
--

DROP TABLE IF EXISTS `element_parent_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `element_parent_mapping` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `element_id` int(11) unsigned NOT NULL,
  `parent_element_id` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `element_id` (`element_id`),
...
CREATE TABLE `elements` (
  ...
  `start_revision_id` int(11) unsigned NOT NULL,
  `end_revision_id` int(11) unsigned DEFAULT NULL,
  `type` varchar(255) NOT NULL,
  `last_modified` bigint(20) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `map_id` (`map_id`),
  KEY `start_revision_id` (`start_revision_id`),
  KEY `end_revision_id` (`end_revision_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3514 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `map_to_user_restriction`
--

DROP TABLE IF EXISTS `map_to_user_restriction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `map_to_user_restriction` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `map_id` smallint(5) unsigned NOT NULL,
...
CREATE TABLE `maps` (
  ...
  `creator_user_id` smallint(5) unsigned NOT NULL,
  `last_root_element_id` int(11) unsigned NOT NULL,
...
CREATE TABLE `templates` (
  ...
  `name` varchar(255) NOT NULL,
  `xmlConfig` text NOT NULL,
  `ontology_id` tinyint(3) unsigned NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Current Database: `nodechat`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `nodechat` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=907902 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=66272 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `room_prefix`
--

DROP TABLE IF EXISTS `room_prefix`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
-- Dump completed on 2020-08-27 17:56:53
