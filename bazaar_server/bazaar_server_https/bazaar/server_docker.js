...
app.use(function(req, res, next) {
    res.setHeader("Content-Security-Policy", "default-src 'self'; connect-src 'self' ws://misty.lti.cs.cmu.edu/bazsocket/ http://misty.lti.cs.cmu.edu/bazsocket/ wss://misty.lti.cs.cmu.edu/bazsocket/ https://misty.lti.cs.cmu.edu/bazsocket/; style-src 'self' https://fonts.googleapis.com/css https://rawgit.com/gtomar/help-button-javascript/master/discussion.css 'unsafe-inline'; script-src 'self' https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js https://rawgit.com/gtomar/stylesheets/master/colors.js https://rawgit.com/gtomar/stylesheets/master/jquery.sortable.js 'unsafe-inline'; font-src 'self' https://fonts.gstatic.com/s/oxygen/v9/2sDfZG1Wl4LcnbuKjk0mRUe0Aw.woff2 https://fonts.gstatic.com/s/oxygen/v9/2sDfZG1Wl4LcnbuKgE0mRUe0A4Uc.woff2; img-src http://www.dnr.sc.gov/climate/sco/Education/wxmap/wxmap.gif http://misty.lti.cs.cmu.edu/favicon.ico"); 
    return next();
});
